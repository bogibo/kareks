...
export default class JsonRpcClient {
    ...
    request(method, ...params) {
        ...
        return fetchWithTimeout(this.endpoint, req, this.config.requestTimeout)
    }
}

const fetchWithTimeout = (uri, options = {}, requestTimeout) => {
    ...
    return fetch(uri, config)
            ...
            .then(res => checkError(res, options, this.config.debug))
